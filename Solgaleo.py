...
async def on_ready():
    ...
    cogs_list_games = ('Cogs.Games.rps', 'Cogs.Games.Chance_Games', 'Cogs.Games.Gunslingers', 'Cogs.Games.pokemon')
    cogs_list_aviation = ('Cogs.Aviation.Airport_Lookup', 'Cogs.Aviation.Schedule', 'Cogs.Aviation.weather', 'Cogs.Aviation.acars', 'Cogs.Aviation.Av_Info')
    cogs_list_util = ('Cogs.Util.Server', 'Cogs.Util.About', 'Cogs.Util.Reminder', 'Cogs.Util.Mods', 'Cogs.Util.Roles', 'Cogs.Util.Help', 'Cogs.Util.link_message')
