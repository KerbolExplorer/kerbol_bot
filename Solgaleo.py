...
async def on_ready():
    ...
    cogs_list_aviation = ('Cogs.Aviation.Airport_Lookup', 'Cogs.Aviation.Airline_Manager', 'Cogs.Aviation.Schedule', 'Cogs.Aviation.Metar', 'Cogs.Aviation.Aircraft_Manager')
