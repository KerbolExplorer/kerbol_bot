...
class Schedule(commands.Cog):
    ...
    async def flightplan(self, interaction:discord.Interaction, simbrief_id:str=None):
        ...
        general_embed.add_field(name="Departure Category:", value=flpn.origin.upper() if flpn.origin else "UNK")
        general_embed.add_field(name="Arrival Category:", value=flpn.destination_cat.upper() if flpn.destination_cat else "UNK")
        ...
        alternate_embed.add_field(name="Alternate Category:", value=flpn.alternate_cat.upper() if flpn.alternate_cat else "UNK")
